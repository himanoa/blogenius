...
pub fn render<T>(body: &str) -> Result<HtmlOutput>
where 
...
fn run_with<T>(builder: SyntectAdapterBuilder, body: &str) -> Result<String>
where 
    T: serde::de::DeserializeOwned,
{
    ...
    return Ok(markdown_to_html_with_plugins(body_without_headers, &options, &plugins));
}
...
mod tests {
    ...
    fn parse_should_be_return_to_heading () {
        ...
        assert_eq!(html.unwrap(), "<h2>Hello</h2>\n")
    }
